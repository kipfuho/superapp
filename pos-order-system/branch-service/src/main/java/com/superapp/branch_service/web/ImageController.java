...
import com.superapp.branch_service.service.ImageService;
import com.superapp.branch_service.web.dto.ImageDtos.AttachImageReq;
import com.superapp.branch_service.web.dto.ImageDtos.PresignDishImageReq;
...
public class ImageController {
    ...
    public Object attach(@PathVariable String dishId, @Valid @RequestBody AttachImageReq req) {
        ImageAsset asset = ImageAsset.builder().key(req.key()).url(req.url()).contentType(req.contentType())
